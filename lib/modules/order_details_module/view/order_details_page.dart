      ...
      body: BlocBuilder<OrderDetailsCubit, OrderDetailsState>(
        builder: (context, state) {
          switch (state) {
            ...
            case OrderDetailsSuccess(:final order):
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        'Ordered: ${dateFormat.format(orderDetails.orderDate)} at ${timeFormat.format(orderDetails.orderDate)}',
                                        style: const TextStyle(
                                          fontSize: 14,
                                          color: Colors.grey,
                                        ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 8),
                                      Text(
                                        'Est. Delivery: ${dateFormat.format(orderDetails.estimatedDeliveryDate)}',
                                        style: const TextStyle(
                                          fontSize: 14,
                                          color: Colors.grey,
                                        ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '\u{20B9}${double.tryParse(orderDetails.totalAmount)?.toStringAsFixed(2) ?? orderDetails.totalAmount}',
                                        style: const TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                          color: Colors.green,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () =>
                                _orderDetailsHelper.makePhoneCall(orderDetails),
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () =>
                                _orderDetailsHelper.openMap(orderDetails),
